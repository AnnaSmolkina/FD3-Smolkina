      ...
      <div className="Contacts">
        ...
        <div className="Contact_form">
          ...
          <form name="INFO" action="http://fe.it-academy.by/TestForm.php" noValidate>
              Введите ваше имя:  <input type='text' name='FIO'/><br/><br/>
              Введите номер телефона: <input type='text' name='NUMBER'/><br/><br/>
              Введите ваш e-mail: <input type='text' name='MAIL'/><br/><br/><br/>
